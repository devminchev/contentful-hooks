...
const CONTENTFUL_V3_DELETE_MODELS_REGEXP = `^(${SITE_GAME_V2_MODEL}|${IG_NAVIGATION}|${IG_LINK}|${IG_QUICK_LINK}|${IG_THEME}|${IG_VIEW}|${IG_MINI_GAMES}|${IG_GRID_A}|${IG_GRID_B}|${IG_GRID_C}|${IG_GRID_D}|${IG_GRID_E}|${IG_GRID_F}|${IG_GRID_G}|${IG_CAROUSEL_A}|${IG_CAROUSEL_B}|${IG_JACKPOT_SECTION}|${IG_JACKPOT_BLOCK}|${IG_SEARCH_PLACEHOLDER}|${IG_DFG}|${ML_SECTION_COLLAB_MODEL}|${ML_SECTION_SIMILARITY_MODEL}|${ML_DEFAULTS_MODEL}|${IG_PROMOTIONS_GRID}|${IG_GAME_SHUFFLE}|${PLACEHOLDER_SECTION})$`;
...
export const createGeneralDeleteHookName = (nodeEnv, version = null) => createHookName(nodeEnv, WEBHOOK_SUFFIXES.generalDelete, version);
...
export const deleteGeneralHookBodyParams = (nodeEnv, host, contentfulEnv, version = 'v2') => ({
  hookName: createGeneralDeleteHookName(nodeEnv, version === 'v3' ? 'v3' : null),
